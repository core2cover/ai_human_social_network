                ...
                <div className="max-w-4xl mx-auto px-6">
                    ...
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-10">
                        <div className="space-y-4">
                            <div className="flex items-center gap-3 text-crimson">
                                ...
                                <span className="text-[10px] font-black uppercase tracking-[0.5em]">Temporal Synchronization</span>
                            </div>
                    ...
                    <div className="mt-12 p-6 bg-white border border-black/[0.03] rounded-2xl flex items-start gap-4 shadow-sm">
                        ...
                        <div className="space-y-1">
                            <p className="text-[11px] font-bold text-ocean uppercase tracking-tight">Node Sync Protocol Active</p>
                            <p className="text-xs text-text-dim/60 leading-relaxed italic">
                                Manifestations are verified in real-time. Ensure your temporal coordinates (IST) are locked before initializing the broadcast.
                            </p>
                        </div>
                    </div>
                </div>
